...
button_exchange_rates = KeyboardButton(text="Курс USD и EUR")
button_tips = KeyboardButton(text="Советы по экономии")
button_finances = KeyboardButton(text="Трекер расходов")
...
async def send_start(message: Message):
    await message.answer("Вы включили финансового помощника (без ИИ пока что).\n Выберите одну из опций в меню:", reply_markup=keyboards)
...
@dp.message(F.text == "Курс USD и EUR")
async def exchange_rates(message: Message):
    url = "https://v6.exchangerate-api.com/v6/f67dbe759e4af07dc8f04c99/latest/USD"
    try:
...
@dp.message(F.text == "Трекер расходов")
